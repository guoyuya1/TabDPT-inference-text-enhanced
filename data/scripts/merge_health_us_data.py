...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Join Health_US numeric + text CSVs by interval overlap."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--numeric",
        default="Time-MMD/numerical/Health_US/Health_US.csv",
        help="Path to numeric CSV.",
    )
    parser.add_argument(
        "--search",
        default="Time-MMD/textual/Health_US/Health_US_search.csv",
        help="Path to search-summary text CSV.",
    )
    parser.add_argument(
        "--report",
        default="Time-MMD/textual/Health_US/Health_US_report.csv",
    ...
    parser.add_argument(
        "-o",
        "--output",
        default="Time-MMD/numerical/Health_US/Health_US_with_text.csv",
