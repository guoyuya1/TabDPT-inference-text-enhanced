...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Join Security numeric + text CSVs by interval overlap."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--numeric",
        default="Time-MMD/numerical/Security/Security.csv",
        help="Path to numeric CSV.",
    )
    parser.add_argument(
        "--search",
        default="Time-MMD/textual/Security/Security_search.csv",
        help="Path to search-summary text CSV.",
    )
    parser.add_argument(
        "--report",
        default="Time-MMD/textual/Security/Security_report.csv",
    ...
    parser.add_argument(
        "-o",
        "--output",
        default="Time-MMD/numerical/Security/Security_with_text.csv",
