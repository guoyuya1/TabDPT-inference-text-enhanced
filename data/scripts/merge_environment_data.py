...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Join Environment numeric + text CSVs by interval overlap."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--numeric",
        default="Time-MMD/numerical/Environment/Environment.csv",
        help="Path to numeric CSV.",
    )
    parser.add_argument(
        "--search",
        default="Time-MMD/textual/Environment/Environment_search.csv",
        help="Path to search-summary text CSV.",
    )
    parser.add_argument(
        "--report",
        default="Time-MMD/textual/Environment/Environment_report.csv",
    ...
    parser.add_argument(
        "-o",
        "--output",
        default="Time-MMD/numerical/Environment/Environment_with_text.csv",
